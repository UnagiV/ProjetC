...
@section('contenu')
    <div class="col-sm-offset-4 col-sm-4">
		...
		<div class="panel panel-primary">
			<div class="panel-heading">Modification d'un Mode de Règlement</div>
			<div class="panel-body">
				<div class="col-sm-12">
					{!! Form::model($modeReglement, ['route' => ['modereglement.update',
          $modeReglement->Id_TCo], 'method' => 'put', 'class' => 'form-horizontal panel']) !!}
